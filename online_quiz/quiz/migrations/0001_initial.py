# Generated by Django 5.1.1 on 2025-01-18 12:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('text', 'Text'), ('image', 'Image'), ('video', 'Video')], max_length=50)),
                ('image', models.ImageField(blank=True, null=True, upload_to='questions/images/')),
                ('video', models.FileField(blank=True, null=True, upload_to='questions/videos/')),
            ],
        ),
        migrations.CreateModel(
            name='User',
